    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Upcomming Album</h4>
                        <div style="display: flex;justify-content: end;"><a
                                href="{{ route('upcomming.slider-image.create') }}" class="btn btn-primary">Create New</a></div>
...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#data-table')) {
                let dTable = $('#data-table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('upcomming.slider-image.index') }}",
                        type: "get",
                    },
        ...
        function deleteItem(id) {
            var url = '{{ route('upcomming.slider-image.delete', ':id') }}';
