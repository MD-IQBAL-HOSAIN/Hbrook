...
@section('content')
    <main>
        ...
        <section>
            <div style="background-image: url('{{ $biographyCms[0]->image_url ? asset('storage/' . $biographyCms[0]->image_url) : asset('frontend/images/sm--banner-01.jpg') }}');"
                class="sm-banner">
                <div class="container">
                    <h1>
                        <span class="sm-banner-color-text">The Life and Legacy of</span>
                        Jean Renard
                    </h1>
                </div>
            </div>
        ...
        <!-- life-and-legacy section starts -->
        <section>
            <div class="container">
                <!-- item1 -->
                <div class="sm-life-and-legacy-wrapper1">
                    <div class="sm-life-and-legacy-left1">
                        @if (!empty($biographyCms[1]->title))
                            <h2>{{ $biographyCms[1]->title ?? '' }}</h2>
                        @else
                            <h2>The Life and Legacy of Jean Renard</h2>
                        @endif
                        <div>
                            {{-- <p>
                            ...
                            @if (!empty($biographyCms[1]->description))
                                {!! $biographyCms[1]->description ?? '' !!}
                            @else
                                <p class="p1">
                                    Jean Renard, a prolific composer and songwriter, embarked on his musical journey in 1958
                                    when he joined SACEM. Teaming up with notable figures like Rolf Marbot and Pierre
                                    Delanoë, Renard's career took off with hits like "À la gare Saint-Lazare" and "Le
                                    premier bonheur du jour."
                                </p>
                                <p class="p2">
                                    His compositions transcended borders with international successes such as "Losing You"
                                    sung by Brenda Lee. Renard's collaboration with Sylvie Vartan marked a significant
                                    milestone in his career, producing hits like "La Maritza" and "Irrésistiblement." In
                                    1969, Renard achieved legendary status by composing "Que je t'aime" for Johnny Hallyday.
                                    Renard's talent extended beyond composing, as he ventured into production, stage
                                    direction, and even musicothérapie.
                                </p>
                                <p>
                                    His legacy lives on through timeless classics and his continuous dedication to the art
                                    of music.
                                </p>
                            @endif
                    ...
                    <div class="sm-life-and-legacy-right1">
                        <img src="{{ $biographyCms[1]->image_url ? asset('storage/' . $biographyCms[1]->image_url) : asset('frontend/images/biography-1.jpeg') }}"
                            alt="" />
                    </div>
                </div>
                <!-- item2 -->
                <div class="sm-life-and-legacy-wrapper2">
                    <div class="sm-life-and-legacy-right2">
                        <img src="{{ $biographyCms[2]->image_url ? asset('storage/' . $biographyCms[2]->image_url) : asset('frontend/images/sm--legacy-01.jpg') }}"
                            alt="" />
                    </div>
                    <div class="sm-life-and-legacy-left2">
                        @if (!empty($biographyCms[2]->title))
                            <h2>{{ $biographyCms[2]->title ?? '' }}</h2>
                        @else
                            <h2>Early Life and Beginnings</h2>
                        @endif
                        <div>

                            @if (!empty($biographyCms[2]->description))
                                {!! $biographyCms[2]->description ?? '' !!}
                            @else
                                <p>
                                    Jean Renard was born in the picturesque town of Provins,
                                    France. His passion for music was evident from a young age,
                                    and he pursued it relentlessly. In 1958, Renard joined SACEM,
                                    marking the beginning of his professional career. His early
                                    works quickly gained recognition, setting the stage for a
                ...
                <!-- item3 -->
                <div class="sm-life-and-legacy-wrapper3">
                    <div class="sm-life-and-legacy-left3">
                        @if (!empty($biographyCms[3]->title))
                            <h2>{{ $biographyCms[3]->title ?? '' }}</h2>
                        @else
                            <h2>Rise to Fame</h2>
                        @endif
                        <div>
                            {{-- <p>
                                Renard's collaboration with legendary artists like Rolf Marbot
                                and Pierre Delanoë catapulted him to fame. Together, they
                                created unforgettable hits such as 'À la gare Saint-Lazare'
                                and 'Le premier bonheur du jour.' These songs resonated with
                                audiences and became staples of French music.
                            </p> --}}
                            @if (!empty($biographyCms[3]->description))
                                {!! $biographyCms[3]->description ?? '' !!}
                            @else
                                <p>
                                    Renard's collaboration with legendary artists like Rolf Marbot
                                    and Pierre Delanoë catapulted him to fame. Together, they
                    ...
                    <div class="sm-life-and-legacy-right3">
                        <img src="{{ $biographyCms[3]->image_url ? asset('storage/' . $biographyCms[3]->image_url) : asset('frontend/images/sm--legacy-02.jpg') }}"
                            alt="" />
                    </div>
                </div>
                <!-- item4 -->
                <div class="sm-life-and-legacy-wrapper4">
                    <div class="sm-life-and-legacy-right4">
                        <img src="{{ $biographyCms[4]->image_url ? asset('storage/' . $biographyCms[4]->image_url) : asset('frontend/images/sm-legacy-03.png') }}"
                            alt="" />
                    </div>
                    <div class="sm-life-and-legacy-left4">
                        @if (!empty($biographyCms[4]->title))
                            <h2>{{ $biographyCms[4]->title ?? '' }}</h2>
                        @else
                            <h2>International Success</h2>
                        @endif
                        <div>
                            {{-- <p>
                                Renard's talent transcended borders, earning him international
                                acclaim. One of his most notable achievements was composing
                                'Losing You,' performed by the iconic Brenda Lee. The song's
                                haunting beauty captivated listeners worldwide and solidified
                                Renard's status as a global musical powerhouse.
                            </p> --}}
                            @if (!empty($biographyCms[4]->description))
                                {!! $biographyCms[4]->description ?? '' !!}
                            @else
                                <p>
                                    Renard's talent transcended borders, earning him international
                                    acclaim. One of his most notable achievements was composing
        ...
        <!-- life-and-legacy section ends -->

        <!-- count section starts -->
        <!-- count section starts -->
        <section class="numbers--area--biography">
            <div class="container">
        ...
        <!-- achievement and honors section starts -->
        <section>
            <div class="achievement-and-honors-wrapper">
                <div class="sm-biography-common-title">
                    <h2>Achievements and Honors</h2>
                    <p>
                        {!! $biographyCms[5]->description ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim' !!}
                    </p>
                </div>
                <div class="owl-carousel owl-theme">
                    ...
                    @if ($achievements->isEmpty())
                        <div class="item">
                            <div class="sm-achievement-and-honors-item">
                                <div class="sm-image-container">
                                    <img class="" src="{{ asset('frontend/images/sm--legacy-01.jpg') }}"
                                        alt="" />
                                </div>
                                <div class="sm-text-container">
                                    <h4>1970s</h4>
                                    <h3>Grand Prix National et International RTL</h3>
                                    <p>
                                        A significant accolade recognizing his impact on both
                                        national and international music scenes. Received in the
                                        early 1970s.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="sm-achievement-and-honors-item">
                                <div class="sm-image-container">
                                    <img class="" src="{{ asset('frontend/images/sm--legacy-02.jpg') }}"
                                        alt="" />
                                </div>
                                <div class="sm-text-container">
                                    <h4>1970s</h4>
                        ...
                        <div class="item">
                            <div class="sm-achievement-and-honors-item">
                                <div class="sm-image-container">
                                    <img class="" src="{{ asset('frontend/images/sm-achievement-02.jpg') }}"
                                        alt="" />
                                </div>
                                <div class="sm-text-container">
                                    <h4>1970s</h4>
                                    <h3>Trophée de la Meilleure Production</h3>
                                    <p>
                                        Honored for his excellence in music production, highlighting his skills in creating
                                        high-quality music. Received in the mid-1970s.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="sm-achievement-and-honors-item">
                                <div class="sm-image-container">
                                    <img class="" src="{{ asset('frontend/images/sm-achievement-03.jpg') }}"
                                        alt="" />
                                </div>
                                <div class="sm-text-container">
                                    <h4>1970s</h4>
                                    <h3>Prix Lucien et Jean Boyer</h3>
                                    <p>
                                        This award acknowledges his significant contributions to the French music industry.
                        ...
                        <div class="item">
                            <div class="sm-achievement-and-honors-item">
                                <div class="sm-image-container">
                                    <img class="" src="{{ asset('frontend/images/sm-achievement-04.jpg') }}"
                                        alt="" />
                                </div>
                                <div class="sm-text-container">
                                    <h4>2000</h4>
                                    <h3>Médaille d’Honneur de la SACEM</h3>
                                    <p>
                                        A special medal awarded by SACEM in recognition of his long-standing and significant
                                        contributions to the music industry. Received in 2000.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        @foreach ($achievements as $item)
                            <div class="item">
                                <div class="sm-achievement-and-honors-item">
                                    <div class="sm-image-container">
                                        <img class=""
                                            src="{{ $item->image_url ? asset('storage/' . $item->image_url) : asset('frontend/images/sm-achievement-01.jpg') }}"
                                            alt="" />
                                    </div>
                                    <div class="sm-text-container">
                                        <h4>{{ $item->year ?? '' }}</h4>
        ...
        <!-- achievement and honors section ends -->
        ...
        <section>
            <div class="container">
                ...
                <div class="sm-biography-common-title">
                    <h2>Gallary</h2>
                    <p class="paragraph">
                        {!! $biographyCms[6]->description ?? 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim' !!}
                    </p>
                </div>
                ...
                @if ($gallaryImages->isEmpty())
                    <div id="sm-gallary-container" class="sm-gallary-grid-wrapper">
                        ...
                        <div class="item6">
                            <img class=" " src="{{ asset('frontend/images/sm-achievement-01.jpg') }}"
                                alt="">
                        </div>
                        <div class="item7">
        ...
        <!-- Iconic composition section starts -->

        <section>
            <div class="sm-iconic-composition-wrapper">
                <div class="sm-biography-common-title">
                    <h2>Iconic Compositions</h2>
                    <p>
                        {!! $biographyCms[7]->description !!}
                    </p>
                </div>
                <div class="owl-carousel owl-theme">
                    @if ($iconicSliders->isEmpty())
                        <div class="item"><img src="{{ asset('frontend/images/stream-2.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-3.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-4.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-1.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-2.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-3.png') }}" alt=""></div>
                        <div class="item"><img src="{{ asset('frontend/images/stream-4.png') }}" alt=""></div>
                    @else
                        @foreach ($iconicSliders as $image)
                            <div class="item"><img
                                    src="{{ $image->image_url ? asset('storage/' . $image->image_url) : asset('frontend/images/stream-1.png') }}"
                                    alt=""></div>
                        @endforeach
                    @endif
                </div>
        ...
        <!-- Iconic composition section ends -->
                ...
                <div class="news-wrapper-container">
                            ...
                            @if ($blogs->isNotEmpty())
                                ...
                                <div class="bottom-text">
                                    ...
                                    <div>
                                        ...
                                        <p class="p2">
                                            {!! Str::limit(strip_tags($firstBlog->details), 200) ?? '' !!}
                                        </p>
                    ...
                    <div class="news-grid-container">
                        <div class="news-grid-left">
                            ...
                            @else
                                <!-- Default content when no blog is available -->
                                {{-- <div class="new-grid-left-image-container">
                                ...
                                <img class="" style="object-fit: cover; width:100%"
                                    src="{{ 'frontend/images/coming_soon.jpg' }}" alt="" />
                        </div>
                    </div>
                    @endif
                </div>
