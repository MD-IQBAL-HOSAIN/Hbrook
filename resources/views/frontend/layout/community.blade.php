...
@push('style')
    ...
    <style>
        ...
        .read-full-post a:hover {
            color: #138496;
            /* Darker shade of info color */
        }
...
@section('content')
    <main class="container bi-community-page">
        ...
        <form class="bi-share-post-container">
            <div class="bi-avatar">
                <img src="{{ asset('frontend/images/bi-community-page-avatar.png') }}" alt="" srcset="" />
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">Post Community</h5>
                    ...
                    <div class="modal-body">
                        <form id="myForm" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="tags-input-wrapper">
                                    <input type="text" class="form-control" name="tag" id="tag"
                                        placeholder="Add a tag" data-role="tagsinput">
                                </div>
                                <div class="invalid-feedback" id="error-tag"></div>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="file" class="dropify form-control form-control-md border-left-0"
                                    name="image" id="image">
                        ...
                        <div class="bi-recent-post">
                            <div class="bi-user-info">
                                <div class="user-image">
                                    <img src="{{ asset('frontend/images/bi-recent-post-user-avatar.png') }}"
                                        alt="User Image" />

                                </div>
                                <a href="#">
                                    <span class="user-name">{{ $post->user->name ?? 'jon doe' }}</span>
                                    <span class="time">{{ $post->created_at->diffForHumans() ?? '12 hours ago' }}</span>
                            ...
                            <div class="bi-post-tags">
                                @if (!empty($post->tag) && is_array($post->tag))
                            ...
                            <div class="bi-recent-post-description">
                                ...
                                <span>
                                    ...
                                    <div class="short-description">{!! Str::limit($post->description, 250) !!}</div>
                                    <span class="full-description" style="display: none;">{!! $post->description !!}</span>
                                    <a href="{{ route('community.singlepost', $post->slug) }}" class="read-full-post">See
                                        more</a>
                            ...
                            <div class="post-view-like-comments">
                                <span> <span>{{ $post->view_count }} Views</span></span>
                ...
                <div class="bi-trending-post-container">
                    ...
                    @foreach ($posts as $trending)
                        <ul class="bi-trending-posts-container">
                            @if (is_array($trending->tag))
                                @foreach ($trending->tag as $tag)
                                    @if (!in_array($tag, $displayedTags))
                                        @php
                                            $displayedTags[] = $tag;
                                        @endphp
                                        <li>
                                ...
                                @endforeach
                            @else
                                @if (!in_array($trending->tag, $displayedTags))
                                    @php
                                        $displayedTags[] = $trending->tag;
                                    @endphp
                                    <li>
                                        <a href="#">
                                            <div class="post-dark">
                                                <span class="tag-item">{{ $trending->tag ?? '' }}</span>
                                            </div>
                                        </a>
                                    </li>
                                @endif
