    ...
    <main>
        ...
        <section>
            <div class="container">
                <div class="hero-text-container">
                    ...
                    <h1 class="notranslate" lang="fr">Paris Accordeon</h1>
                    <h2 class=""><strong>New Release</strong></h2>
                </div>
                <!-- carousel -->
                        ...
                        <div class="carousel-inner">
                            @if ($sliderImage->isEmpty())
                                <div class="carousel-item active image-wrapper" data-bs-interval="2500">
                                    <img src="{{ asset('frontend/images/hero-carousel.jpg') }}" class="d-block carousel-img"
                                        alt="..." />
                ...
                <div class="stream-left">
                    <div class="stream--content--left">
                        <div class="stream-text-container">
                            ...
                            <h2>{{ $cms[0]->title ? $cms[0]->title : 'Jean Renard' }}</h2>
                        </div>
                        <div>
                            {!! $cms[0]->description ??
                        ...
                        <div class="d-flex">
                            <a href="#">
                                {{ $cms[0]->button_text ? $cms[0]->button_text : 'Stream' }}
                ...
                <div class="stream-carousel-container">
                    <div class="owl-carousel owl-theme">
                        @if ($gallaryImage->isEmpty())
                            <div class="item">
                                <img src="{{ asset('frontend/images/stream-1.png') }}" alt="" />
                            </div>

                            <div class="item">
                                <img src="{{ asset('frontend/images/stream-2.png') }}" alt="" />
                            </div>

                            <div class="item">
                                <img src="{{ asset('frontend/images/stream-3.png') }}" alt="" />
                            </div>
                        @else
                            @foreach ($gallaryImage as $item)
                                <div class="item">
                                    <img src="{{ $item->image_url ? asset('storage/' . $item->image_url) : asset('frontend/images/stream-1.png') }}"
                                        alt="" />
                                </div>
                            @endforeach
                        @endif
                ...
                <div class="biography-wrapper d-flex gap-3">
                    <div class="flex-grow-1 left-wrapper">
                        ...
                        <div class="d-flex button-container">
                            <a href="{{ route('biography') }}" class="d-flex gap-3 align-items-center">
                                Learn More
                                <svg class="bio-arrow" xmlns="http://www.w3.org/2000/svg" width="111" height="16"
                                    viewBox="0 0 111 16" fill="none">
                                    <path
                    ...
                    <div class="flex-grow-1 right-wrapper">
                        {{-- <div class="d-flex box-wrapper">
                            <svg xmlns="http://www.w3.org/2000/svg" width="131" height="12" viewBox="0 0 131 12"
                                fill="none">
                                <rect x="86.9453" y="0.31543" width="43.3155" height="10.8289" fill="#25285E" />
                                <rect x="43.6289" y="0.31543" width="43.3155" height="10.8289" fill="#DF3931" />
                                <rect x="0.316406" y="0.31543" width="43.3155" height="10.8289" fill="#EEC52A" />
                            </svg>
                        ...
                        <div class="d-flex box-wrapper">
                            <img width="50px" height="30px" src="{{ asset('frontend/images/flag.png') }}"
                                alt=""
                                style="
                                width: 120px;
                                object-fit: contain;height: auto;border-radius: 0px;margin-bottom: 0px;">
                        </div>
                        <div class="d-flex title flex-column gap-1">
                            <h4 class="">JEAN RENARD:</h4>
                            <p>{{ $cms[2]->title ?? 'A Legacy of Melodic Mastery' }}</p>
                        </div>
                        <div>
                            <img src="{{ $cms[2]->image_url ? asset('storage/' . $cms[2]->image_url) : asset('frontend/images/biography-1.jpeg') }}"
                                alt="" />
                        </div>
                            ...
                            <div class="music-body">
                                <div class="layer">
                                    <div class="volume-slider">
                                        <span class="bar"></span>
                                        <input type='range' min='0.01' max='1' value='1'
                                            step='0.01' class="volumerange" />
                                    </div>
                                </div>
                                <div class="music-img">
        ...
        url('{{ $cms[7]->image_url ? asset('storage/' . $cms[7]->image_url) : asset('frontend/images/album-3.png') }}');"
            ...
            <div class="home-video-list">
                <a
                    href="{{ $cms[7]->youtube_url ? asset('storage/' . $cms[7]->youtube_url) : 'https://www.youtube.com/watch?v=QdP876o5F2g' }}"></a>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="featured-products-container mt_15">
                    ...
                    @if ($products->isEmpty())
                        ...
                        <img class="" src="{{ 'frontend/images/coming_soon.jpg' }}" alt="" />
                    @else
                        @foreach ($products as $product)
                            <a href="{{ route('product.show', $product->slug) }}" class="featured-grid-container">
                                @php
                                    $firstImage = $product->images->first()->image_url;
                                @endphp
                                <img class=""
                                    src="{{ $firstImage ? asset('storage/' . $firstImage) : asset('frontend/images/featured-product1.jpg') }}"
                                    alt="" />
                                <div class="d-flex bottom-wrapper justify-content-between">
                                    <div class="text-container">
                                        <h4>{{ $product->name ?? '' }}</h4>
                                        {{-- <p>80 Pages, Black</p> --}}
                                        @foreach ($product->ptags as $index => $tag)
                                            <span class="text-secondary">{{ $tag->name }}</span>

                                            @if ($index < $product->ptags->count() - 1)
                                                ,
                                            @endif
                                        @endforeach
                    ...
                    <div class="news-grid-container">
                        <div class="news-grid-left">
                            ...
                            @else
                                ...
                                {{-- <h2 class="d-flex justify-content-center"> Comming Soon..... </h2> --}}
                        ...
                        <div class="news-grid-right">
                            @if ($blogs->isNotEmpty())
                                ...
                                @endforeach
                            @else
                                <!-- Default small blog previews -->
                                {{-- <div class="d-flex gap-2 text-container">
                                    <div class="image-container">
                                        <img class="" src="{{ asset('frontend/images/news-1.jpg') }}"
                                            alt="" />
                                    </div>
                                    <div class="p-2 d-flex justify-content-center flex-column">
                                        <h4>05 MAY 2024</h4>
                                ...
                                <div class="d-flex gap-2 text-container">
                                    <div class="image-container">
                                        <img class="" src="{{ asset('frontend/images/news-2.jpg') }}"
                                            alt="" />
                                    </div>
                                    <div class="p-2 d-flex justify-content-center flex-column">
                                        <h4>05 MAY 2024</h4>
                                ...
                                <div class="d-flex gap-2 text-container">
                                    <div class="image-container">
                                        <img class="" src="{{ asset('frontend/images/news-3.jpg') }}"
                                            alt="" />
                                    </div>
                                    <div class="p-2 d-flex justify-content-center flex-column">
                                        <h4>05 MAY 2024</h4>
