                            ...
                            @if ($blogs->isNotEmpty())
                                ...
                                <div class="bottom-text">
                                    <div class="d-flex gap-2 profile-container">
                                        <img class=""
                                            src="{{ $firstBlog->user->image ? asset('storage/' . $firstBlog->user->image) : asset('frontend/images/profile-1.png') }}"
                                            alt="" />
                                        <div>
            ...
            <div class="container">
                <div class="sm-biography-trending-wrapper">
                    @if ($allBlogs->isEmpty())
                        {{-- <div class="sm-item1">
                            <div class="img1">
                                <img src="{{ asset('frontend/images/sm-achievement-01.jpg') }}" alt="">
                            </div>
                            <div class="top-date">
                                <h3>24</h3>
                                <h4>FEB</h4>
                            ...
                            <div class="bottom-text">
                                ...
                                <div class="profile-section">
                                    <img class="profile-image" src="{{ asset('frontend/images/profile-1.png') }}"
                                        alt="">
                                    <div>
                                        <h3>Samantha Ryan</h3>
                                        <p>Author, HydroCBD</p>
        ...
        <section class="recent--interviews">
            <div class="container">
                ...
                @else
                    ...
                    @foreach ($interviews as $interview)
                        <div class="recent-interview-video-list">
                            <a href="{{ $interview->video_url ? asset('storage/' . $interview->video_url) : '' }}"></a>
