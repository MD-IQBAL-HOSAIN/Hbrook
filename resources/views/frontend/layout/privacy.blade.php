...
@section('content')
    <main>
        <section class="hbrook-terms">
            <div class="container">
                {{-- <div class="terms-conditions">
             <h1>Privacy Policy</h1>
             <p class="last-update">Last updated: June 28, 2024</p>
             <section>
                 <h2>1. Introduction</h2>
                 <p>Jean Renard's MusicStream is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.</p>
             </section>
             <section>
                 <h2>2. Information We Collect</h2>
                 <p>We may collect personal information such as your name, email address, and payment information when you register on our site, subscribe to our newsletter, or make a purchase.</p>
             </section>
             <section>
                 <h2>3. How We Use Your Information</h2>
                 <p>We use the information we collect to provide, maintain, and improve our services, to process transactions, to communicate with you, and to personalize your experience on our website.</p>
             </section>
             <section>
             ...
             <section>
                 <h2>6. Your Rights</h2>
                 <p>You have the right to access, correct, or delete your personal information, as well as to object to or restrict certain processing of your data. You can exercise these rights by contacting us at <a href="mailto:privacy@jeanrenardmusic.com">privacy@jeanrenardmusic.com</a>.</p>
             </section>
             <section>
             ...
             <section>
                 <h2>8. Contact Us</h2>
                 <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@jeanrenardmusic.com">privacy@jeanrenardmusic.com</a>.</p>
             </section>
         </div> --}}
                <div class="terms-conditions">
                    <h1>Privacy Policy</h1>
                    ...
                    <section>
                        ...
                        <p>This privacy policy outlines the conditions under which any information (including personal data,
                            as defined by applicable data protection law) collected from you, or provided by you through our
                            website, will be processed by us or by third-party partners mentioned in our legal notices.
                            Please read this document carefully to understand our practices regarding your information and
                            how we will handle it. The purpose of this privacy policy is to inform users of our site about
                            the personal data we collect as well as the following, if applicable:
                        </p>
                        <p>1. The personal data we collect</p>
                        <p>2. The use of the data collected</p>
                        <p>3. Who has access to the collected data</p>
                        <p>4. The rights of site users</p>
                        <p>5. The site’s cookie policy</p>
                        <p>6. This privacy policy operates alongside the general terms and conditions of our site.</p>
                    ...
                    <section>
                        ...
                        <p>In accordance with the General Data Protection Regulation (GDPR), this privacy policy complies with the following regulations. Personal data must be:
                        </p>
                    </section>
                    <section>
                        <h2>3. How We Use Your Information</h2>
                        <p>We use the information we collect to provide, maintain, and improve our services, to process
                            transactions, to communicate with you, and to personalize your experience on our website.</p>
                    </section>
                    <section>
                        <h2>4. Sharing Your Information</h2>
                    ...
                    <section>
                        <h2>6. Your Rights</h2>
                        <p>You have the right to access, correct, or delete your personal information, as well as to object
                            to or restrict certain processing of your data. You can exercise these rights by contacting us
                            at <a href="mailto:privacy@jeanrenardmusic.com">privacy@jeanrenardmusic.com</a>.</p>
                    </section>
                    <section>
                        <h2>7. Changes to This Privacy Policy</h2>
                        <p>We may update our Privacy Policy from time to time. Any changes will be posted on this page with
                            an updated revision date. We encourage you to review this Privacy Policy periodically.</p>
                    </section>
                    <section>
                        <h2>8. Contact Us</h2>
                        <p>If you have any questions about this Privacy Policy, please contact us at <a
                                href="mailto:privacy@jeanrenardmusic.com">privacy@jeanrenardmusic.com</a>.</p>
                    </section>
                </div>
            </div>
        </section>
        ...
        <section>
            <div class="send-notes-wrapper">
                <svg class="" xmlns="http://www.w3.org/2000/svg" width="254" height="59" viewBox="0 0 254 59"
                    fill="none">
                    <path
